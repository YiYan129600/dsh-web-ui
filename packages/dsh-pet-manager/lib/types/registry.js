...
export const BUILTIN_PET_PROVIDERS = [
    {
        entryId: 'pet',
...
export function providerByEntryId(entryId) {
...
export function classifyToggleMode(manifest) {
...
export function extractManagedEntries(text) {
    const map = new Map();
    let inSection = false;
    let currentId = null;
...
export function applyManagedDisabled(text, entryId, disabled) {
